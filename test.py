...
while True:
    ...
    if kq:
        for hand_landmarks in kq:
            ...
            # Khoảng cách ngón trỏ - cái, trỏ - út
            dist_tro_cai = ((lm8x-lm4x)**2  + (lm8y-lm4y)**2)**0.5
            dist_tro_ut  = ((lm8x-lm20x)**2 + (lm8y-lm20y)**2)**0.5

            # Ngón cái hướng lên/xuống
            cai_gio   = hand_landmarks.landmark[4].y < hand_landmarks.landmark[2].y
            cai_xuong = hand_landmarks.landmark[4].y > hand_landmarks.landmark[2].y
            ...
            if dist_tro_cai < 30:
                ...
                cv2.putText(frame, "CLICK TRAI", (10,30),
